                      ...
                      <div className="flex-grow">
                        ...
                        {item.selectedOptions && (
                          <div className="text-xs text-foreground/60 mt-1">
                            {Object.entries(item.selectedOptions).map(([key, value]) => value && <div key={key}>+ {key.replace('_', ' ')}</div>)}
                          </div>
                        )}
                        <p className="text-sm text-primary font-semibold font-roboto-mono mt-1">
                          ${item.totalPrice ? item.totalPrice.toFixed(2) : item.numericPrice.toFixed(2)} USD
                        </p>
